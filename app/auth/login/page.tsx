...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[url('https://images.unsplash.com/photo-1550439062-609e1531270e?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80')] bg-cover bg-center p-4">
      ...
      <Card className="w-full max-w-md bg-gray-900/90 border-gray-800 shadow-2xl relative z-10 animate-slide-in">
        ...
        <CardContent>
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            ...
            <Link href="/auth/signup" className="text-blue-500 hover:text-blue-400 hover:underline transition-colors">
              Sign up
            </Link>
          </p>
        </CardContent>
